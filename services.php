...
<form style="margin-bottom: 20px;">
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Website Url">
...
<option value="Tanzania">Tanzania</option>
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Address" style="padding-right: 50px;">
 
  </div>
</div>
    
  <button type="submit" class="btn btn-primary" id="add_service">Add Service Provider</button>
</form>
</div>
</div>
</div>
...
<div class="container">
  ...
  <button type="submit" id="submit4"  class="btn btn-primary" style="display: inline-block; float:right;" >New Service Provider</button>
</div>
