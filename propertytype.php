...
<div class="container" style="padding-bottom: 20px;" id="cont"> 
 <div class="row"> <!-- Content Header (Page header) -->

<div class="col-md-12" id="formy">
<form style="margin-bottom: 20px;">
  ...
  <button type="submit" id="add_property" class="btn btn-primary">Add Property Type</button>
</form>
</div>
</div>
</div>
...
<div class="container">
  ...
  <button type="submit" id="submit1"  class="btn btn-primary" style="display: inline-block; float:right;" >New Property Type</button>
</div>
