...
<option value="Tanzania">Tanzania</option>
 ...
 <div class="col-md-12">
  <div class="form-group">
    ...
    <input type="" class="form-control" id="exampleInputEmail8" aria-describedby="emailHelp" placeholder="Enter County">
...
<div class="col-md-12" >
  <div class="form-group">
    ...
    <input type="" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter City" style="padding-right: 50px;">
 ...
 <div class="col-md-12" >
  <div class="form-group">
    ...
    <input type="" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Address" style="padding-right: 50px;">
  ...
  <button type="submit" class="btn btn-primary" id="add_property">Add Property</button>
</form>
</div>
</div>
</div>
...
<div class="container">
  ...
  <button type="submit" id="submit7"  class="btn btn-primary" style="display: inline-block; float:right;" >New Property</button>
</div>
