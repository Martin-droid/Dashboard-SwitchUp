...
<form style="margin-bottom: 20px;">
  ...
  <button type="submit" class="btn btn-primary" id="add_method">Add Payment Method</button>
</form>
</div>
</div>
</div>
...
<div class="container">
  ...
  <button type="submit" id="submit3"  class="btn btn-primary" style="display: inline-block; float:right;" >New Payment Method</button>
</div>
