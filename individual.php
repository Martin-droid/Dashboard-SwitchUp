...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #002D62">
    ...
    <a href="index3.html" class="brand-link">
      <img src="img\switch2.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="">
...
<option value="Tanzania">Tanzania</option>
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter County">
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter City" style="padding-right: 50px;">
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter ID Type" style="padding-right: 50px;">
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter ID Number" style="padding-right: 50px;">
 
  </div>
</div>
    
  <button type="submit" class="btn btn-primary" id="add_tenant1">Add Tenant</button>
</form>
</div>
</div>
</div>
...
<div class="container">
  ...
  <button type="submit" id="submit6"  class="btn btn-primary" style="display: inline-block; float:right;" >New Tenant</button>
</div>
