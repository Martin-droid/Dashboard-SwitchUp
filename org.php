...
<option value="Tanzania">Tanzania</option>
 ...
 <div class="col-md-12" >
  ...
  <button type="submit" class="btn btn-primary" id="add_tenant">Add Tenant</button>
</form>
</div>
</div>
</div>
...
<div class="container">
  ...
  <button type="submit" id="submit5"  class="btn btn-primary" style="display: inline-block; float:right;" >New Tenant</button>
</div>
