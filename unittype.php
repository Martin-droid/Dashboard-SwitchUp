...
<form style="margin-bottom: 20px;">
  ...
  <button type="submit" class="btn btn-primary" id="add_unit">Add Unit Type</button>
</form>
</div>
</div>
</div>
...
<div class="container">
  ...
  <button type="submit" id="submit1"  class="btn btn-primary" style="display: inline-block; float:right;" >New Unit Type</button>
</div>
